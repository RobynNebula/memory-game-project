<header class="head">
    <section>
        ...
        <div class="linkContainer">
          <a href="<?php echo PROJECT_FOLDER ?>accueil.php" <?php ?>> Accueil </a>
          <a href="<?php echo PROJECT_FOLDER ?>login.php"> login </a>
          <a href="<?php echo PROJECT_FOLDER ?>games/memory/thèmeLevel.php"> Jeu </a>
          ...
          <a href="<?php echo PROJECT_FOLDER ?>MyAccount.php">
